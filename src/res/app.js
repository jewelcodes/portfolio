...
const contactText = "\
    * Email: [oelghoul@bu.edu](mailto:oelghoul@bu.edu)\n\
...
const mainText = "\
    ...
    I'm a software engineer from the [land of the pyramids](https://en.wikipedia.org/wiki/Cairo) currently living in [Boston](https://en.wikipedia.org/wiki/Boston). \
